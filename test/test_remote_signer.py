...
class TestRemoteSigner(unittest.TestCase):
    ...
    def vote_test(self, req, got):
        ...
        self.assertEqual(
            rs.sign(SignatureReq(req[-1]), {"private_handle": 7}), SIGNED_BLOCK
        )
        ...
        with self.assertRaises(Exception):
            ...
            rs.sign(SignatureReq(req[-1]), {"private_handle": 7})
    ...
    def test_identifies_invalid_block_preamble(self):
        with self.assertRaises(Exception):
            ...
            rs.sign(SignatureReq(INVALID_PREAMBLE), {"private_handle": 7})
    ...
    def test_list_sigreqs(self):
        for req in valid_sig_reqs:
            ...
            self.assertEqual(
                rs.sign(SignatureReq(req[4]), {"private_handle": 7}), SIGNED_BLOCK
            )
            ...
            with self.assertRaises(Exception):
                ...
                rs.sign(SignatureReq(req[4]), {"private_handle": 7})
